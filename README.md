...
## Analysis steps
In this section, we presented the analysis steps of using the Perturb-STNet algorithm for detecting proteins and estimating their dynamic patterns and regulatory profiles to investigate the impact of T-cell therapy on melanoma. The Perturb-STNet R functions are well documented in the "utilityFunctionGithub" file in the repository (https://github.com/NIEHS/Perturb-STNet), where the definition of all the parameters in the functions can be found. 
...
```
![image](https://github.com/user-attachments/assets/64dc87d9-fb0e-47e5-a47d-efe7c72b9433)
